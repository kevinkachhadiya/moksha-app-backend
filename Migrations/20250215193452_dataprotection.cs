        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalBillPrice = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SId = table.Column<int>(name: "S_Id", type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    SBillNo = table.Column<string>(name: "S_BillNo", type: "character varying(50)", maxLength: 50, nullable: false),
                    SellerName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    TotalSPrice = table.Column<decimal>(name: "Total_S_Price", type: "numeric(10,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    PaymentMethod = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    RemainAmount = table.Column<decimal>(type: "numeric", nullable: false),
                    IsPaid = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableStock = table.Column<decimal>(type: "numeric(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PStockId = table.Column<int>(name: "P_Stock_Id", type: "integer", nullable: false),
                    StBags = table.Column<int>(name: "St_Bags", type: "integer", nullable: false),
                    StWeight = table.Column<decimal>(name: "St_Weight", type: "numeric(18,2)", nullable: false),
                    price = table.Column<decimal>(type: "numeric", nullable: false),
                    StockId = table.Column<int>(type: "integer", nullable: false),
                    SBillSId = table.Column<int>(name: "S_BillS_Id", type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_S_BillItems", x => x.ID);
                    table.ForeignKey(
